...
echo -e "\033[46;33m-------------------------fail2ban安装---------------------------------\033[0m"
# 目标文件路径
file="/etc/fail2ban/jail.local"
sed -i '101d' /etc/fail2ban/jail.local
sed -i '101i\bantime = 10000000m' /etc/fail2ban/jail.local
sed -i '101s/bantime = .*/bantime = 10000000m/' /etc/fail2ban/jail.local
sed -i '108s/maxretry = .*/maxretry = 1/' /etc/fail2ban/jail.local
sed -i '111s/maxmatches = .*/maxmatches = 1/' /etc/fail2ban/jail.local
sed -i '281,282d' /etc/fail2ban/jail.local
sed -i '182d' /etc/fail2ban/jail.local
cat <<EOT > /tmp/insert.txt
filter = sshd
...
filter = sshd
EOT
sudo sed -i '281r /tmp/insert.txt' /etc/fail2ban/jail.local
rm /tmp/insert.txt
